...
<th><strong>Požiadavka</strong></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><strong>Funkčnosť (F)</strong></td>
<td><p>- Tri prepínateľné režimy (ECO, PERFORMANCE, RACE).</p>
<p>- Podpora dvoch základných 2D HW alternatív (telefón+podložka / samostatný 2D projektor) a prémiovej laserovej AR verzie.</p>
<p>- Prepojenie s ADAS/ACC.</p>
<p>- Záznam porušenia rýchlosti pre Políciu SR v ECO móde.</p></td>
</tr>
<tr class="even">
<td><strong>Použiteľnosť (U)</strong></td>
<td><p>- Intuitívne prepínanie režimov pred jazdou.</p>
<p>- Odstránenie rizika prehrievania telefónu voľbou dedikovaného 2D projektora.</p></td>
</tr>
<tr class="odd">
<td><strong>Spoľahlivosť (R)</strong></td>
<td><p>- Hardware fail-over (prepnutie z laseru na 2D projektor alebo telefón).</p>
<p>- Šifrovaný lokálny sklad pre záznamy porušení.</p></td>
</tr>
<tr class="even">
<td><strong>Výkon (P)</strong></td>
<td>- Latencia &lt; 200 ms, obnovovacia frekvencia až 30 Hz pre laserovú projekciu.</td>
</tr>
<tr class="odd">
<td><strong>Schopnosť údržby (S)</strong></td>
<td>- Modulárna podpora rôznych typov displejov a HUD projektorov prostredníctvom jednotného rozhrania.</td>
</tr>
</tbody>
</table>
...
<img src="./media/image1.png" style="width:5.85457in;height:4.34133in" />
...
<img src="./media/image2.png" style="width:5.87545in;height:4.03488in" />
...
<img src="./media/image3.png" style="width:5.84922in;height:6.19123in" />
...
<img src="./media/image4.png" style="width:6.26806in;height:9.40208in" />
...
<img src="./media/image5.png" style="width:6.26806in;height:4.17847in" />
