...
o	Varianta A (Smartfón + 2D reflexná podložka): Cenovo najdostupnejšie riešenie využívajúce displej telefónu. 
o	Varianta B (Základný samostatný 2D HUD projektor): Dedikovaná dostupná zobrazovacia jednotka pripojená k telefónu/OBD, ktorá kompletne rieši a eliminuje riziko prehrievania smartfónu počas letných dní.
